  ...
  <q-page>
    <div class="q-pa-md">
      ...
      >
        ...
        <template v-slot:top>
          <!--<q-btn color="teal" :disable="loading" label="Tambah Data Transaksi" to="/DataTransaksi"/>-->
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'total', align: 'center', label: 'Jumlah Beli', field: 'total' }
      ],
      data: [
        {
        ...
        {
          kodetransaksi: 'Transn-004',
          namapembeli: 'AriSetiawan',
          judulbuku: 'Belajar HTML Untuk Pemula',
          hargabuku: '450000',
          jumlahbeli: '1',
          total: '450000'
        }
